...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT           600  // (seconds) Time limit before the nozzle is turned off for safety. // updated by John Carlson to allow for a 10 minute timeout
